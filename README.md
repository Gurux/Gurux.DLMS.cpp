...
You can report the [issues](https://www.gurux.fi/project/issues/gurux.dlms.cpp). 
...
You do not necessary need to use Gurux media component like gurux.net.cpp or gurux.serial.cpp 
You can use any connection library you want to.
Gurux.DLMS classes only generate and parse the DLMS data.

You can get [source codes](https://www.github.com/gurux/gurux.dlms.cpp) 
